...
public class ByteUtil {
    ...
    /**
     * 将byte数组指定范围转成int, 小端模式
     *
     * @param bytes
     * @param start 起始位，计算时包括该位
     * @param end   结束位，计算时包括该位
     * @return
     */
    ...
    public static long byteToLongForLittleEndian(byte[] bytes) {
        long result = 0;
    ...
    public static void main(String[] args){
        //12C
        byte[] b1 = new byte[]{0x2C, 0x01};
        int i = byteToIntForLittleEndian(b1);
        System.out.println(i);

        byte[] b2 = new byte[]{0x01, 0x2C};
        int i1 = byteToInt(b2);
